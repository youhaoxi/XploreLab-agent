...
data = [
    {
        "Topic": "体育",
        "Question": (
            "在某个知名的葡萄酒产区中的某个地区存在一个只产某种葡萄酒的地区，距离此地区20-40公里范围内存在一家足球俱乐部，"
            "那么该足球俱乐部最近一次升入上一级联赛提前几轮确定？"
        ),
        "Answer": "1轮",
    ...
    },
    {
        "Topic": "影视",
        "Question": (
            "20世纪二十年代中在上海成立的刊物成为了我国知名学生运动的先导，在此次运动中占据领导地位的高校在近百年后有一名在21世纪初某少"
            "儿电视剧中扮演重要角色的演员入学，那么请问在此电视剧中的男一号是什么时间结婚"
        ),
        "Answer": "2019年4月23日",
        "canary": "BrowseComp-ZH",
    },
