...
class PlannerOutputParser:
    ...
    def parse(self, output_text: str) -> PlannerOutput:
        ...
        return PlannerOutput(analysis=analysis, plan=plan, next_step=next_step, task_finished=task_finished)
    ...
    def _extract_plan(self, text: str) -> List[PlannerTask]:
        ...
        for agent_name, task_desc, completed_str in task_matches:
            ...
            tasks.append(PlannerTask(agent_name=agent_name, task=task_desc, completed=completed))
    ...
    def to_dict(self, parsed_output: PlannerOutput) -> Dict:
        ...
        result = {
            ...
            "plan": [
                {"agent_name": task.agent_name, "task": task.task, "completed": task.completed}
