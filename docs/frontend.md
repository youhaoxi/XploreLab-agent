...
Download prebuilt wheel file (`utu_agent_ui-0.1.5-py3-none-any.whl`) from [releases](https://github.com/utu-agent/utu-agent/releases) and run the following command:
